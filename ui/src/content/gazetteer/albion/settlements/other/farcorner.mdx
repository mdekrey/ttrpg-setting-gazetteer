...
export const ogDescription = 'Farcorner is a small, superstitious hamlet known for its exceptional produce grown from the latent magic of the nearby West Weald, where the residents are welcoming to outsiders but mindful of the treaty established with the fey.';
